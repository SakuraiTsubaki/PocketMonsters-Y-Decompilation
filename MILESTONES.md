# Milestones: Pocket Monsters Y

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-Y-Decompilation`.
...
Coordinate format findings with X and separate shared Generation VI structures from title-specific data.
